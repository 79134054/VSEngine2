...
void VSDX9Renderer::SetUserConstantWorldViewProjectMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX9Renderer::SetUserConstantWorldViewMatrix(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
...
void VSDX9Renderer::SetMaterialVShaderConstant(MaterialShaderPara &MSPara,unsigned int uiPassType,VSVShader *pVShader)
{
	unsigned int ID = 0;
...
void VSDX9Renderer::SetUserConstantLightFuntionSampler(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSArray<VSLight*> & LightArray = MSPara.LightArray;
	for (unsigned int i = 0 ; i < LightArray.GetNum() ; i++)
	{
...
void VSDX9Renderer::SetUserConstantShadowSampler(MaterialShaderPara &MSPara,VSShader * pShader,unsigned int& ID)
{
	VSArray<VSLight*> & LightArray = MSPara.LightArray;
	for (unsigned int i = 0 ; i < LightArray.GetNum() ; i++)
	{
...
void VSDX9Renderer::SetMaterialPShaderConstant(MaterialShaderPara &MSPara,unsigned int uiPassType,VSPShader *pPShader)
{
	unsigned int ID = 0;
	if (uiPassType == VSPass::PT_MATERIAL)
	{
...
void VSDX9Renderer::SetMaterialGShaderConstant(MaterialShaderPara &MSPara, unsigned int uiPassType, VSGShader *pGShader)
{
