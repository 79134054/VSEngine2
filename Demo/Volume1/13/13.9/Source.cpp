//这个Demo演示地形DLOD，加载了一个高程图作为地形。按W可以切换线框模式。
...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSDLodTerrainActor * pTerrainActor = (VSDLodTerrainActor *)VSWorld::ms_pWorld->CreateActor<VSDLodTerrainActor>(VSVector3(-1300.0f, -2000, -1300.0f), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
