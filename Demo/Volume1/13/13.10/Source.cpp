...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSCLodTerrainActor * pTerrainActor = (VSCLodTerrainActor *)VSWorld::ms_pWorld->CreateActor<VSCLodTerrainActor>(VSVector3(-1300.0f, 0.0f, -1300.0f), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
