//这个Demo演示地形DLOD，创建了一个空地形。按W可以切换线框模式。
...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSWorld::ms_pWorld->CreateActor<VSDLodTerrainActor>(VSVector3(-1300.0f, 0, -1300.0f), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
