//加载Demo14.11的模型，读者可以跟踪下混合流程，用“+”“-”按键调节阈值查看混合的效果。
...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	pSKActor3 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithTwoSmoothBlendAnim.SKMODEL"), VSVector3(0, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(0, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change SmoothAnimBlendParamter"));
	VSRenderer::ms_pRenderer->DrawText(0, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("SmoothAnimBlendParamter:%f"), m_fPencent);
	return true;
}
