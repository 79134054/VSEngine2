...
namespace VSEngine2
{
	...
	bool MaterialSaverDemo::OnInitial()
	{
		...
		VSAnimTreeRPtr pAnimTree = VSResourceManager::LoadASYNAnimTree(_T("AnimTreeOneAnim.ANIMTREE"), false);
		...
		VSResourceManager::NewSaveSkelectonMeshNode(pSkelectonMeshNode, _T("NewMonsterWithOneAnim"), true);
