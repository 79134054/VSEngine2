//加载Demo14.8的模型，读者可以跟踪下用AnimTree播放单一动画的流程。
...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkelectonActor * pSKActor3 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithOneAnim.SKMODEL"), VSVector3(0, 0, 1800), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
