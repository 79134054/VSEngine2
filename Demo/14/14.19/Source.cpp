...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkelectonActor * pSKActor4 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithPartialAnim1.SKMODEL"), VSVector3(1200, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	VSSkelectonActor * pSKActor1 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithPartialAnim2.SKMODEL"), VSVector3(600, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	...
	pSKActor3->GetTypeNode()->PlayAnim(_T("Attack2"), 1.0f, VSController::RT_WRAP);
