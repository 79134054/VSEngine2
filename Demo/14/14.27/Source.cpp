...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSMonsterActor1 * pMonsterActor1 = (VSMonsterActor1 *)VSWorld::ms_pWorld->CreateActor<VSMonsterActor1>(VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	...
	pMonsterActor1->AddCanSeeSence(SceneMap);
