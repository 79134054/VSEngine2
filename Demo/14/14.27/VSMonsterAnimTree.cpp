	...
	:VSAnimTree(ShowName)
{
	...
	pIdle_Attack->SetNodeCrossFadingTime(0, 100.0f);
	pIdle_Attack->SetNodeCrossFadingTime(1, 100.0f);
...
:VSAnimTree(ShowName)
{
	...
	pIdle_Walk->GetInputNode(1)->Connection(pAnimSequenceAttack->GetOutputNode(0));
	...
	pBlend_Attack->GetInputNode(1)->Connection(pAnimSequenceWalk->GetOutputNode(0));
