...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSDirectionLightActor * pDirLightActor = (VSDirectionLightActor*)VSWorld::ms_pWorld->CreateActor<VSDirectionLightActor>(VSVector3(700, 700, 0.0f), Dir, VSVector3::ms_One, m_pTestMap);
	pDirLightActor->GetTypeNode()->m_Diffuse = VSColorRGBA(5.0f, 5.0f, 5.0f, 1.0f);
	pDirLightActor->GetTypeNode()->m_Specular = VSColorRGBA(5.0f, 5.0f, 5.0f, 1.0f);
	pDirLightActor->GetTypeNode()->SetLightMaterial(pLightFun);
