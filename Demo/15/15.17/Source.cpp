...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkelectonActor * pSKActor1 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterIsotropicWard.SKMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText( 0, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change Roughness0"));
	VSRenderer::ms_pRenderer->DrawText( 0, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("Roughness0:%f"), Roughness0);
	VSRenderer::ms_pRenderer->DrawText( 0, 680, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '[' And ']' to Change Roughness1"));
	VSRenderer::ms_pRenderer->DrawText( 0, 700, VSDWCOLORABGR(255, 255, 255, 255), _T("Roughness1:%f"), Roughness1);
	return true;
}
