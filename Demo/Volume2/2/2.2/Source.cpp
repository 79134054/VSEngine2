//加载14.3导出的模型并渲染，循环播放7个动画，第4个为根骨动画，第6个位叠加动画，第7个位pos，仔细观察根骨动画和其他动画的不同
...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkelectonActor * pSKActor1 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-1200, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor1->GetTypeNode()->SetIsDrawSkelecton(true);
	pSKActor1->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor1->GetTypeNode()->PlayAnim(_T("Idle"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor2 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-600, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor2->GetTypeNode()->SetIsDrawSkelecton(true);
	pSKActor2->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor2->GetTypeNode()->PlayAnim(_T("Walk"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor3 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(0, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor3->GetTypeNode()->SetIsDrawSkelecton(true);
	pSKActor3->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor3->GetTypeNode()->PlayAnim(_T("Attack"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor4 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(600, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor4->GetTypeNode()->SetIsDrawSkelecton(true);
	pSKActor4->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor4->GetTypeNode()->PlayAnim(_T("RootMotion"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor5 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(1200, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor5->GetTypeNode()->SetIsDrawSkelecton(true);
	pSKActor5->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor5->GetTypeNode()->PlayAnim(_T("Attack2"), 1.0f, VSController::RT_WRAP);


	VSSkelectonActor * pSKActor6 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(1800, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor6->GetTypeNode()->SetIsDrawSkelecton(true);
	pSKActor6->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor6->GetTypeNode()->PlayAnim(_T("Pos"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor7 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(2400, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor7->GetTypeNode()->SetIsDrawSkelecton(true);
	pSKActor7->GetTypeNode()->SetIsDrawBoundVolume(true);
