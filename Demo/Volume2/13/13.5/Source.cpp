...
// 	{
// 		float x = VSFRand() * 4000.0f - 2000.0f;
// 		float z = VSFRand() * 4000.0f - 2000.0f;
// 		unsigned int m = VSRand() % 5 + 2;
// 		VSWorld::ms_pWorld->CreateActor(_T("NewFaceMorphWithTwoMorph.STMODEL"), VSVector3(x, 0.0f, z + 1000.0f), VSMatrix3X3::ms_Identity, VSVector3(m, m, m), m_pTestMap);
// 	}
