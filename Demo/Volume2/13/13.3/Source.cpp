...
bool VSDemoWindowsApplication::PreInitial()
{
	...
	VSResourceManager::ms_EnableAsynLoad = true;
	return true;
}
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(0, 640, VSDWCOLORABGR(255,255,255,255), _T("Use Key 'P' to Asyn Load Scene Map"));
	return true;
}
...
void VSDemoWindowsApplication::OnKeyDown(unsigned int uiKey)
{
	...
	{
		VSWorld::ms_pWorld->LoadMap(_T("Test"), true);	
	}
}
