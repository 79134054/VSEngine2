...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkelectonActor * pSKActor1 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterAnisotropicWard.SKMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::PostUpdate()
{
	...
	pMaterialInstance0->SetPShaderValue(_T("RoughnessX"), &RoughnessX0, sizeof(RoughnessX0));
	pMaterialInstance1->SetPShaderValue(_T("RoughnessX"), &RoughnessX1, sizeof(RoughnessX1));

	pMaterialInstance0->SetPShaderValue(_T("RoughnessY"), &RoughnessY0, sizeof(RoughnessY0));
	pMaterialInstance1->SetPShaderValue(_T("RoughnessY"), &RoughnessY1, sizeof(RoughnessY1));
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(500, 540, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change RoughnessX0"));
	VSRenderer::ms_pRenderer->DrawText(500, 560, VSDWCOLORABGR(255, 255, 255, 255), _T("RoughnessX0:%f"), RoughnessX0);
	VSRenderer::ms_pRenderer->DrawText(500, 580, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '[' And ']' to Change RoughnessX1"));
	VSRenderer::ms_pRenderer->DrawText(500, 600, VSDWCOLORABGR(255, 255, 255, 255), _T("RoughnessX1:%f"), RoughnessX1);

	VSRenderer::ms_pRenderer->DrawText(500, 620, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '1' And '2' to Change RoughnessY0"));
	VSRenderer::ms_pRenderer->DrawText(500, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("RoughnessY0:%f"), RoughnessY0);
	VSRenderer::ms_pRenderer->DrawText(500, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'F1' And 'F2' to Change RoughnessY1"));
	VSRenderer::ms_pRenderer->DrawText(500, 680, VSDWCOLORABGR(255, 255, 255, 255), _T("RoughnessY1:%f"), RoughnessY1);
