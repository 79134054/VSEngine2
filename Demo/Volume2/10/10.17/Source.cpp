...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSpotLightActor * pSpotLightActor = (VSSpotLightActor*)VSWorld::ms_pWorld->CreateActor<VSSpotLightActor>(VSVector3(700.0f, 700.0f, 0.0f), Dir, VSVector3::ms_One, m_pTestMap);
 	pSpotLightActor->GetTypeNode()->m_Diffuse = VSColorRGBA(15.0f, 15.0f, 15.0f, 1.0f);
 	pSpotLightActor->GetTypeNode()->m_Specular = VSColorRGBA(15.0f, 15.0f, 15.0f, 1.0f);
 	pSpotLightActor->GetTypeNode()->SetLightMaterial(pLightFun);
