...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(700, 400, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change NU0"));
	VSRenderer::ms_pRenderer->DrawText(700, 420, VSDWCOLORABGR(255, 255, 255, 255), _T("NU0:%f"), NU0);
	VSRenderer::ms_pRenderer->DrawText(700, 440, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '[' And ']' to Change NU1"));
	VSRenderer::ms_pRenderer->DrawText(700, 460, VSDWCOLORABGR(255, 255, 255, 255), _T("NU1:%f"), NU1);

	VSRenderer::ms_pRenderer->DrawText(700, 480, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '1' And '2' to Change NV0"));
	VSRenderer::ms_pRenderer->DrawText(700, 500, VSDWCOLORABGR(255, 255, 255, 255), _T("NV0:%f"), NV0);
	VSRenderer::ms_pRenderer->DrawText(700, 520, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'F1' And 'F2' to Change NV1"));
	VSRenderer::ms_pRenderer->DrawText(700, 540, VSDWCOLORABGR(255, 255, 255, 255), _T("NV1:%f"), NV1);

	VSRenderer::ms_pRenderer->DrawText(700, 560, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '3' And '4' to Change Rs0"));
	VSRenderer::ms_pRenderer->DrawText(700, 580, VSDWCOLORABGR(255, 255, 255, 255), _T("Rs0:%f"), Rs0);
	VSRenderer::ms_pRenderer->DrawText(700, 600, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'F3' And 'F4' to Change Rs1"));
	VSRenderer::ms_pRenderer->DrawText(700, 620, VSDWCOLORABGR(255, 255, 255, 255), _T("Rs1:%f"), Rs1);
