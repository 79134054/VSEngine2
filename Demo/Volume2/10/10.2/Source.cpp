...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSWorld::ms_pWorld->AttachCaptureViewFamilyToCamera(pReflectCameraActor, 
				...
				512, 512, SceneMap, VSSimpleForwordEffectSceneRenderMethod::ms_Type.GetName().GetBuffer());
	...
	pMaterialInstance->SetPShaderTexture(_T("EmissiveTexture"), pCaptureTexR);
...
bool VSDemoWindowsApplication::PostUpdate()
{
	...
	pMaterialInstance->SetPShaderValue(_T("ReflectViewProject_1 "), &Column[0], sizeof(VSVector3W));
	pMaterialInstance->SetPShaderValue(_T("ReflectViewProject_2 "), &Column[1], sizeof(VSVector3W));
	pMaterialInstance->SetPShaderValue(_T("ReflectViewProject_3 "), &Column[2], sizeof(VSVector3W));
	pMaterialInstance->SetPShaderValue(_T("ReflectViewProject_4 "), &Column[3], sizeof(VSVector3W));
	return true;
}
