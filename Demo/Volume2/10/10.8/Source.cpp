...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkelectonActor * pSKActor1 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterMinnaert.SKMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::PostUpdate()
{
	...
	pMaterialInstance0->SetPShaderValue(_T("Power"), &Power0, sizeof(Power0));
	pMaterialInstance1->SetPShaderValue(_T("Power"), &Power1, sizeof(Power1));
	return true;
}
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(0, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change Power0"));
	VSRenderer::ms_pRenderer->DrawText(0, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("Power0:%f"), Power0);
	VSRenderer::ms_pRenderer->DrawText(0, 680, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '[' And ']' to Change Power1"));
	VSRenderer::ms_pRenderer->DrawText(0, 700, VSDWCOLORABGR(255, 255, 255, 255), _T("Power1:%f"), Power1);
	return true;
}
