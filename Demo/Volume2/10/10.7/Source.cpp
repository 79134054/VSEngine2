...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkelectonActor * pSKActor1 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterOrenNayar.SKMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::PostUpdate()
{
	...
	pMaterialInstance0->SetPShaderValue(_T("RoughnessSquared"), &RoughnessSquared0, sizeof(RoughnessSquared0));
	pMaterialInstance1->SetPShaderValue(_T("RoughnessSquared"), &RoughnessSquared1, sizeof(RoughnessSquared1));
	return true;
}
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(0, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change RoughnessSquared0"));
	VSRenderer::ms_pRenderer->DrawText(0, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("RoughnessSquared0:%f"), RoughnessSquared0);
	VSRenderer::ms_pRenderer->DrawText(0, 680, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '[' And ']' to Change RoughnessSquared1"));
	VSRenderer::ms_pRenderer->DrawText(0, 700, VSDWCOLORABGR(255, 255, 255, 255), _T("RoughnessSquared1:%f"), RoughnessSquared1);
	return true;
}
