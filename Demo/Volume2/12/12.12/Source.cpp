...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSStaticActor * pSKActor1 = (VSStaticActor *)VSWorld::ms_pWorld->CreateActor(_T("SV_TestCube.STMODEL"), VSVector3(-300, 50, -300), VSMatrix3X3::ms_Identity, VSVector3(5.0f,5.0f,5.0f), m_pTestMap);


	VSStaticActor * pSKActor2 = (VSStaticActor *)VSWorld::ms_pWorld->CreateActor(_T("SV_TestSphere.STMODEL"), VSVector3(300, 50, 300), VSMatrix3X3::ms_Identity, VSVector3(5.0f, 5.0f, 5.0f), m_pTestMap);


	VSStaticActor * pSKActor3 = (VSStaticActor *)VSWorld::ms_pWorld->CreateActor(_T("SV_TestTorus.STMODEL"), VSVector3(-300, 50, 300), VSMatrix3X3::ms_Identity, VSVector3(5.0f, 5.0f, 5.0f), m_pTestMap);
	...
	VSPointLightActor * pPointLightActor = (VSPointLightActor*)VSWorld::ms_pWorld->CreateActor<VSPointLightActor>(VSVector3(0.0f, 500.0f, 0.0f), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pPointLightActor->GetTypeNode()->SetShadowType(VSPointLight::ST_VOLUME);
