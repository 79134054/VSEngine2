...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSVector3 CameraPos(0.0f, 300.0f, 2500.0f);
	...
	VSSkelectonActor * pSKActor1 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-1600, 0, 1600), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSKActor1->GetTypeNode()->PlayAnim(_T("Idle"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor2 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(0, 0, 1600), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSKActor2->GetTypeNode()->PlayAnim(_T("Walk"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor3 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(1600, 0, 1600), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	...
	VSSkelectonActor * pSKActor5 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-1600, 0,-1600), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSKActor5->GetTypeNode()->PlayAnim(_T("Attack2"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor6 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(0, 0, -1600), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSKActor6->GetTypeNode()->PlayAnim(_T("Pos"), 1.0f, VSController::RT_WRAP);

	VSSkelectonActor * pSKActor7 = (VSSkelectonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(1600, 0, -1600), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	...
	//VSPointLightActor * pPointLightActor = (VSPointLightActor*)VSWorld::ms_pWorld->CreateActor<VSPointLightActor>(VSVector3(0.0f,200.0f,0.0f), Dir, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::PostUpdate()
{
	...
	VSMatrix3X3 Dir;
	Dir.CreateEluer(0, AngleToRadian(30), AngleToRadian(m_fAngle));
