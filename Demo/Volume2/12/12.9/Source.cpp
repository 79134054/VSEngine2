...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSVector3 CameraPos(0.0f, 900.0f, 900.0f);
	...
	pPointLightActor->GetTypeNode()->SetShadowType(VSPointLight::ST_PROJECT);
	pPointLightActor->GetTypeNode()->m_ProjectShadowFallOff = 2.0f;
