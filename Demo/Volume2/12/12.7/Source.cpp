...
// 	VSWorld::ms_pWorld->CreateActor(_T("LightPhone.STMODEL"), VSVector3(-1500, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("TablePhone.STMODEL"), VSVector3(-1200, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("Table1Phone.STMODEL"), VSVector3(-900, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("Table2Phone.STMODEL"), VSVector3(-600, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("ChairPhone.STMODEL"), VSVector3(-300, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("Chair1Phone.STMODEL"), VSVector3(0, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("Chair2Phone.STMODEL"), VSVector3(300, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("ModelPhone.STMODEL"), VSVector3(600, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("RadioPhone.STMODEL"), VSVector3(900, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("FanPhone.STMODEL"), VSVector3(1200, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("ZhuZiPhone.STMODEL"), VSVector3(1500, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	VSWorld::ms_pWorld->CreateActor(_T("ZhuZi1Phone.STMODEL"), VSVector3(1800, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
// 	
	...
	for (unsigned int i = 0; i < 200; i++)
	{
		...
		VSWorld::ms_pWorld->CreateActor(Path[s].GetBuffer(), VSVector3(x, 0, z), VSMatrix3X3::ms_Identity, VSVector3(m, m, m), m_pTestMap);
	}

	VSStaticActor* pStaticActor = (VSStaticActor*)VSWorld::ms_pWorld->CreateActor(_T("NewOceanPlane.STMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3(500.0f, 500.f, 500.0f), m_pTestMap);
