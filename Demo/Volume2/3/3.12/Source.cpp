//把Demo14.17保存的AnimTree资源，设置到骨骼模型中，并保存。
#ifndef VSSAMPLE_H
#define VSSAMPLE_H
...
namespace VSEngine2
{
	...
	bool MaterialSaverDemo::OnInitial()
	{
		...
		VSAnimTreeRPtr pAnimTree1 = VSResourceManager::LoadASYNAnimTree(_T("AnimTreePartialAnim1.ANIMTREE"), false);
		...
		VSResourceManager::NewSaveSkelectonMeshNode(pSkelectonMeshNode, _T("NewMonsterWithPartialAnim1"), true);


		VSAnimTreeRPtr pAnimTree2 = VSResourceManager::LoadASYNAnimTree(_T("AnimTreePartialAnim2.ANIMTREE"), false);
		...
		VSResourceManager::NewSaveSkelectonMeshNode(pSkelectonMeshNode, _T("NewMonsterWithPartialAnim2"), true);
		return true;
	}
}
#endif