//把Demo14.10保存的AnimTree资源，设置到骨骼模型中，并保存。
#ifndef VSSAMPLE_H
#define VSSAMPLE_H
...
namespace VSEngine2
{
	...
	bool MaterialSaverDemo::OnInitial()
	{
		...
		VSAnimTreeRPtr pAnimTree = VSResourceManager::LoadASYNAnimTree(_T("AnimTreeTwoSmoothBlendAnim.ANIMTREE"), false);
		...
		VSOutPutDebugString("Save VSEngine Model NewMonsterWithTwoSmoothBlendAnim\n");
		printf("Save VSEngine Model NewMonsterWithTwoSmoothBlendAnim\n");
		VSResourceManager::NewSaveSkelectonMeshNode(pSkelectonMeshNode, _T("NewMonsterWithTwoSmoothBlendAnim"), true);
